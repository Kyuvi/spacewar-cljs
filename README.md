...
Version 1.0 can be played  [Here](https://kyuvi.codeberg.page/spacewar-cljs/@cmp/resources/public/). This is meant to be a two player game so do not expect too much from the AI.
